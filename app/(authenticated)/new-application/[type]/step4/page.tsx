...
export default function Step4Page() {
  ...
  const handlePayNow = async () => {
    ...
    setPaid(true);
    setPaying(false);
    window.location.href = "https://www.lbp-eservices.com/egps/portal/Transactions.jsp";
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col items-center justify-center gap-3">
          ...
          <div className="w-36 h-36 relative">
            <Image
              src="/linkbizportal.png"
              alt="LinkBiz Portal Logo"
              fill
            ...
            <div className="w-36 h-36 bg-gray-100 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300">
              <span className="text-xs text-gray-400 text-center px-2">LinkBiz Portal</span>
            </div>
          </div>
