          ...
          <div className="flex-1 max-w-xl z-10">
            ...
            <div className="flex items-center gap-3 mb-3">
              <Link
                ...
                className="inline-flex items-center gap-2.5 px-8 py-3 bg-[#F5A623] text-white font-bold rounded-lg hover:bg-[#E09510] transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 text-sm w-full sm:w-[270px] justify-center"
              >
